...
<div class="flex gap-4">
  <a href="https://devpost.com/software/pipe-lie" class="inline-flex items-center gap-1.5"><Icon name="simple-icons:devpost" class="w-5 h-5" />Devpost</a>
  <a href="https://github.com/PipeLieDev/pe-hackathon" class="inline-flex items-center gap-1.5"><Icon name="simple-icons:github" class="w-5 h-5" />GitHub Repo</a>
</div>
